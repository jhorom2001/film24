...
public class Controlador {
	...
	public String checkPedidoInfo(@Valid PedidoForm pedidoForm, BindingResult bindingResult, Model model) {
		...
		Pedido pedido1 = new Pedido(null, pedidoForm.getPelicula(), pedidoForm.getAnyo(), pedidoForm.getDirector(),
				pedidoForm.getDuracion(), pedidoForm.getCategoria(), pedidoForm.getUsuario());
